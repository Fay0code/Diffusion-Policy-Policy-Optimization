...
class TrainAgent:
    ...
    def __init__(self, cfg):
        ...
        #     self.seed = 42  # Default to 42 if cfg.get("seed") returns None
    ...
    def save_model(self):
        ...
        tf.keras.models.save_weights(data, savepath)
        # use different save method for tf models
    ...
    def load(self, itr):
        ...
        data = tf.keras.models.load_weights(loadpath)
        # use different load method for tf models
